...
<body>
                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <button class="btn btn-primary border-0">Tambah Produk</button>
                                        </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-primary me-1">Update Stock</button>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- Tombol Update Stok -->
                                                    <button class="btn btn-primary me-1 updateStockBtn"
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="updateStockModalLabel">Update Stok Produk
                                                                    </h5>
                                                                    ...
                                                                    <form id="updateStockForm">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="number" class="form-control"
                                                                                id="productStock" name="product_stock"
                                                                                required>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                    ...
                                                    <!-- Tombol Delete -->
                                                    <button class="btn btn-danger deleteProductBtn"
                                                    ...
                                                    <div class="modal fade" id="deleteProductModal" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="deleteProductModalLabel">Konfirmasi Hapus
                                                                    </h5>
                                                                    <button type="button" class="btn-close"
                                                                        data-bs-dismiss="modal"
                                                                        aria-label="Close"></button>
    ...
    <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Hand-crafted & made with <i class="ti-heart text-danger ms-1"></i></span>
        ...
        $(document).ready(function() {
          // Ketika tombol "Update Stok" diklik, isi modal dengan data yang sesuai
          ...
          // Saat tombol "Update" diklik, kirim data via AJAX
          $('#saveStock').on('click', function(e) {
              ...
              $.ajax({
                  url: `/product/${productId}/update-stock`, // URL sesuai dengan route
                  type: 'PUT', // Menggunakan PUT sesuai dengan route di Laravel
                  data: formData,
                  ...
                  error: function(xhr) {
                      alert('Gagal memperbarui stok! ' + xhr.responseText);
        ...
        <script>
            $(document).ready(function() {
                // Saat tombol delete diklik, isi modal dengan data produk
                ...
                $('#confirmDelete').on('click', function() {
                    ...
                    $.ajax({
                        url: '/delete-product/' + productId, // Pastikan route sesuai
                        type: 'DELETE',
                        data: {
                            _token: csrfToken,
                            _method: 'DELETE'
                        }, // Kirim CSRF Token & DELETE method
                        headers: {
                            'X-CSRF-TOKEN': csrfToken
                        }, // Tambahkan CSRF Token di header
                        success: function(response) {
                            alert(response.message);
                            $('#deleteProductModal').modal('hide'); // Tutup modal
                            location.reload(); // Reload halaman setelah hapus
                        },
                        error: function(xhr) {
                            alert('Gagal menghapus produk! Periksa kembali.');
                            console.error(xhr.responseText);
                        }
                    });
                });
